...
def main(referenced_paper, input_sec, batch_size=1, debug=False):
    ...
    sys.path.append(
        os.path.join(
            os.path.dirname(__file__), "..", "..", "datasets", referenced_paper
        )
    )
    ...
    audiodir = os.path.join(
        os.path.dirname(__file__), "..", "..", "datasets", referenced_paper, "audio"
    )
    ...
    state_dict = safetensors.torch.load_file(
        os.path.join("..", "..", "..", "models", "model.safetensors"),
        device=str(device),
    )
